...
**先理解，再重写**　翻译前会分析论点、术语、语域和翻译难点，建立全局理解。翻译时按母语习惯重组句式和信息节奏，而非逐句直译。

**长文本质量稳定**　长文本会先分片，生成共享术语表和翻译提示词，再委派 subagent 并行翻译，确保跨分片的术语和风格统一。

**可按需继续打磨**　翻译完成后可继续选择审校（逐段对照原文审校 + 脱离原文润色）、精编（显化文章重点与结构 / 为读者可能缺失的信息添加注释 / 统一中文排版与格式）或双语版（原文与译文逐段对照）。

**关键决策人把关**　分片边界调整、排版修正审阅等高风险且不适合纯文本描述的环节，均提供可视化预览界面，逐条确认后再落地。

**本地留存可追溯**　所有中间产物都保存在本地，随时可以回来继续处理。
